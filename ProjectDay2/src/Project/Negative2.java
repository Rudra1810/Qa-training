...
public class Negative2 {
	public static void main(String[] args) throws InterruptedException {
		...
		// password
		driver.findElement(By.xpath("//input[@formcontrolname='password']")).sendKeys("Ru");
		Thread.sleep(10000);
		WebElement errorMessageElement = driver.findElement(By.xpath("(//span[@class=\"text-danger error-font\"])[1]"));
