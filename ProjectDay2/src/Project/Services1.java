...
public class Services1 {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement dropdownElement3 = driver.findElement(By.xpath("//select[@formcontrolname='frequency']"));
		...
		driver.findElement(By.xpath("//input[@class='ng-tns-c117-3 p-inputtext p-component ng-star-inserted']")).click();
				...
				driver.findElement(By.xpath("(//td[@class=\"ng-tns-c117-3 ng-star-inserted\"])[14]")).click();
